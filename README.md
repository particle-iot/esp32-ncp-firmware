...
- Ensure the xtensa-esp32 toolchain is in your PATH. It can be downloaded from the [ESP-IDF Programming Guide](https://docs.espressif.com/projects/esp-idf/en/stable/get-started/index.html#setup-toolchain).
